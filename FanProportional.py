...
import RPi._GPIO as IO          # Calling GPIO to allow use of the GPIO pins
...
IO.setmode (IO.BCM)            # BCM pin numbers - PIN35 as ‘GPIO19’
IO.setup(19,IO.OUT)            # Initialize GPIO19 as our fan output pin
fan = IO.PWM(19,200)           # Set GPIO19 as a PWM output, with 100Hz frequency (this should match your fans specified PWM frequency)
